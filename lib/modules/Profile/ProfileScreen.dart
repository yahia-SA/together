  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProfileCubit, ProfileStates>(
      listener: (context, state) {
        ...
        if (state is ProfileErrorUpdateUserState) {
          showToast(text: state.error, state: ToastStates.ERROR);
        }
      ...
      builder: (context, state) {
        if (state is ProfileLoadingState ||
            state is ProfileLoadinguserpostsState &&
        ...
        }
        {
          return FutureBuilder(
              ...
              builder: (contextF, snapshot) {
                username.text = ProfileCubit.get(context)
                    .profilemodel!
                    .datamodel!
                    .data!
                    .name!;
                email.text = ProfileCubit.get(context)
                    .profilemodel!
                    .datamodel!
                    .data!
                    .email!;
...
buildpostsItem(Data data, context) {
  if (data.type == 'Lend') {
    return GiveawayCard(
      ...
      onPressed: () => ProfileCubit.get(context).deleteuserposts(data.sId),
      name: 'Delete',
      iconPressed: () {
        ProfileCubit.get(context).changeFavorites(data.sId, data.available);
      },
    ...
    return BorrowCard(
      ...
      price: data.price.toString(),
      onPressed: () {
        ProfileCubit.get(context).deleteuserposts(data.sId);
      },
      name: 'Delete',
      icon: data.available! ? Icons.visibility_off : Icons.visibility,
      iconPressed: () {
